...
// Route::middleware('auth:sanctum')->get('/dogadjaji/search', [DogadjajController::class, 'search']);
// Ne može da stoji ovde funkcija za dogadjaji/search jer imamo gore funkciju koja koristi DogadjajController:class .
// Tako da ova funkcija mora da bude iznad nje!